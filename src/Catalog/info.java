...
public class info extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bAmInteles = new javax.swing.JButton();
        ...
        jLabel1.setText("Buna ziua.");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(39, 12, -1, -1));

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Acesta este un calculator electronic..Etapele folosirii lui sunt urmatoarele:");
        ...
        bAmInteles.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bAmIntelesActionPerformed(evt);
            }
        });
        getContentPane().add(bAmInteles, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 360, 150, 53));

        jLabel14.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(0, 0, 0));
        jLabel14.setText("la purtare");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, -1, -1));

        jLabel12.setForeground(new java.awt.Color(0, 0, 0));
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Catalog/wood-889x593.jpg"))); // NOI18N
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 620, 430));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void bAmIntelesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAmIntelesActionPerformed
this.setVisible(false);    
    }//GEN-LAST:event_bAmIntelesActionPerformed
    ...
    private javax.swing.JButton bAmInteles;
